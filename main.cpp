...
int main() {
    ...
    for (int j = image_height - 1; j >= 0; --j) {
        ...
        for (int i = 0; i < image_width; ++i) {
            threads.emplace_back([](int i, int j, int image_width, int image_height, int samples_per_pixel, int max_depth, const camera& cam, const hittable_list& world, color * pixel) {
                ...
                *pixel = pixel_color;
            }, i, j, image_width, image_height, samples_per_pixel, max_depth, cam, world, &(image[j][i]));
        }
